...
if database_url:
    ...
    # Remove pgbouncer and other unsupported parameters
    ...
    # Fallback: use a valid PostgreSQL URL format if no DATABASE_URL is set
    # This prevents the "Can't load plugin: driver" error
    config.set_main_option("sqlalchemy.url", "postgresql://localhost/dan")
